...
- **فاز دو: در حال توسعه** — فروش عملیاتی، فاکتور، پرداخت، ابطال/برگشت موجودی و نمایش عمومی امن فاکتور در شاخهٔ فعلی پیاده‌سازی شده و در حال تکمیل پوشش محصولی است.
