...
- نمایش دسته‌بندی
- نمایش برند
- نمایش قفسه و سبد انبار («انبار اصلی · A-03 · سبد ۲»)
- نمایش موجودی فعلی
...
- انتقال به قفسهٔ دیگر
- انتقال به سبد دیگرِ همان قفسه
...
```text
SearchBox
Filter chips: همه، کمبود، دسته، قفسه، سبد
...
- موجودی اولیه
- قفسه/مکان
- سبد (اختیاری — باید از سبدهای همان قفسه انتخاب شود)
- حداقل موجودی
- تصویر اختیاری
- وضعیت فعال/مخفی
