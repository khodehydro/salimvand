...
.sv-theme[data-theme=light]{--sv-bg:#f3f6fa;--sv-surface:#fff;--sv-surface-2:#f7fafd;--sv-surface-3:#eef3f9;--sv-border:#dce4ee;--sv-text:#0b1c2f;--sv-text-2:#4a5f79;--sv-text-3:#8095ad;--sv-primary:#0d2b4b;--sv-link:#175894;--sv-ok:#0f8f52;--sv-warn:#b9770b;--sv-danger:#c8383c}
.sv-theme[data-theme=dark]{--sv-bg:#050b14;--sv-surface:#0d1826;--sv-surface-2:#111f31;--sv-surface-3:#16283c;--sv-border:#1d3049;--sv-text:#eaf1f9;--sv-text-2:#9db1c8;--sv-text-3:#6c8299;--sv-primary:#2f7fce;--sv-link:#69a8e6;--sv-ok:#3ecf8e;--sv-warn:#f0b454;--sv-danger:#ff7a7f}
.sv-btn{border:1px solid transparent;border-radius:10px;font:inherit;cursor:pointer;padding:9px 16px;transition:.15s}.sv-btn:focus-visible,.sv-input:focus-visible{outline:3px solid color-mix(in srgb,var(--sv-link) 35%,transparent);outline-offset:2px}.sv-btn:disabled{cursor:not-allowed;opacity:.55}.sv-btn-sm{padding:6px 10px;font-size:12px}.sv-btn-lg{padding:12px 22px}.sv-btn-primary{background:var(--sv-primary);color:#fff}.sv-btn-outline{background:transparent;color:var(--sv-text);border-color:var(--sv-border)}.sv-btn-soft{background:color-mix(in srgb,var(--sv-link) 12%,transparent);color:var(--sv-link)}.sv-btn-ghost{background:transparent;color:var(--sv-text-2)}.sv-btn-danger{background:var(--sv-danger);color:#fff}.sv-badge{display:inline-flex;border-radius:999px;padding:3px 9px;font-size:12px}.sv-badge-neutral{background:var(--sv-border);color:var(--sv-text-2)}.sv-badge-ok{background:color-mix(in srgb,var(--sv-ok) 15%,transparent);color:var(--sv-ok)}.sv-badge-warn{background:color-mix(in srgb,var(--sv-warn) 15%,transparent);color:var(--sv-warn)}.sv-badge-danger{background:color-mix(in srgb,var(--sv-danger) 15%,transparent);color:var(--sv-danger)}.sv-card{background:var(--sv-surface);border:1px solid var(--sv-border);border-radius:14px;padding:16px}.sv-field{display:grid;gap:6px;color:var(--sv-text-2);font-size:13px}.sv-field small{font-size:11px;color:var(--sv-text-3)}.sv-input{width:100%;box-sizing:border-box;border:1px solid var(--sv-border);border-radius:10px;background:var(--sv-surface);color:var(--sv-text);padding:10px;font:inherit}@media (prefers-reduced-motion: reduce){.sv-btn{transition:none}}
`;
