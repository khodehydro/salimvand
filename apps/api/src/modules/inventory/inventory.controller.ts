...
export class InventoryController {
  ...
  @Get('reconciliation') @Roles('manager', 'warehouse') reconciliation() {
    return this.inventory.reconciliation();
  }
  @Get('barcode/:code') barcode(@Param('code') code: string) {
    return this.inventory.byBarcode(code);
  }
