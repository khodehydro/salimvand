import { IsBoolean, IsEnum, IsNumberString, IsOptional, IsString, IsUUID, Matches, MaxLength } from 'class-validator';
...
export enum CustomerPaymentMethod { cash = 'cash', card = 'card', transfer = 'transfer', credit = 'credit' }
