...
type Page = 'dashboard' | 'products' | 'inventory' | 'invoices' | 'media' | 'references' | 'reports' | 'settings' | 'users' | 'customers';
...
const pageTitles: Record<Page, string> = { dashboard: 'داشبورد', products: 'کاتالوگ محصولات', inventory: 'انبار و موجودی', invoices: 'فروش و فاکتورها', media: 'رسانه‌ها', references: 'برندها و خودروها', reports: 'گزارش‌ها', settings: 'تنظیمات سیستم', users: 'کاربران و نقش‌ها', customers: 'مشتریان' };
