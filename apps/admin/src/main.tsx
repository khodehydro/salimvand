...
type Page = 'dashboard' | 'products' | 'inventory' | 'invoices' | 'media' | 'references' | 'reports' | 'settings' | 'users' | 'customers' | 'suppliers';
type NavItem = { id: Page; label: string; icon: string; roles?: UserRole[] };
const navItems: NavItem[] = [
  { id: 'dashboard', label: 'داشبورد', icon: '⌂' }, { id: 'suppliers', label: 'تأمین‌کنندگان', icon: '♧', roles: ['manager', 'super_admin', 'accountant'] }, { id: 'invoices', label: 'فروش و فاکتورها', icon: '▤' }, { id: 'customers', label: 'مشتریان', icon: '♙' }, { id: 'products', label: 'کاتالوگ محصولات', icon: '▦' }, { id: 'inventory', label: 'انبار و موجودی', icon: '⌗' }, { id: 'media', label: 'رسانه‌ها', icon: '◫' }, { id: 'references', label: 'برندها و خودروها', icon: '◇', roles: ['manager', 'super_admin'] }, { id: 'reports', label: 'گزارش‌ها', icon: '◒', roles: ['manager', 'super_admin', 'accountant'] }, { id: 'settings', label: 'تنظیمات', icon: '⚙', roles: ['manager', 'super_admin'] }, { id: 'users', label: 'کاربران', icon: '♙', roles: ['super_admin'] },
];
const pageTitles: Record<Page, string> = { dashboard: 'داشبورد', products: 'کاتالوگ محصولات', inventory: 'انبار و موجودی', invoices: 'فروش و فاکتورها', media: 'رسانه‌ها', references: 'برندها و خودروها', reports: 'گزارش‌ها', settings: 'تنظیمات سیستم', users: 'کاربران و نقش‌ها', customers: 'مشتریان', suppliers: 'تأمین‌کنندگان' };
