export const pageIds = ['dashboard', 'products', 'inventory', 'invoices', 'media', 'references', 'reports', 'settings', 'users', 'audit', 'messaging', 'customers', 'suppliers', 'purchases'] as const;
